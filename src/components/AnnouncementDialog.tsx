...
export const AnnouncementDialog = () => {
  ...
  useEffect(() => {
    ...
    const hasSeenAnnouncement = localStorage.getItem("hasSeenRookAnnouncement");
      ...
      <DialogContent className="sm:max-w-md bg-white border-none shadow-premium p-6">
        <DialogHeader className="space-y-3">
          ...
          <DialogDescription className="text-gray-700 mt-2 leading-relaxed">
            Rook's Core Offerings Including Digital Marketing, Tech Solutions, And Strategic Consulting Are Now Delivered Through Realm By Rook.
            <p className="mt-3 font-medium text-gray-900">Same team. New platform. Expanded capabilities.</p>
          </DialogDescription>
        </DialogHeader>
        <div className="py-5">
          <p className="text-gray-700 mb-3">To explore services or get started, visit:</p>
          <Button 
