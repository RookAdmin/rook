      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 md:space-y-8 relative">
            <div className="space-y-4 md:space-y-6 animate-fade-down" style={{ animationDelay: "0.1s" }}>
              ...
              <p className="text-base sm:text-lg md:text-xl text-black max-w-2xl leading-relaxed animate-fade-up" style={{ animationDelay: "0.3s" }}>
                We craft focused SaaS products that empower creators, freelancers, and
                founders to get more done with less.
              </p>
              
              {/* Benefit indicators */}
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 mt-6 md:mt-8 animate-fade-up" style={{ animationDelay: "0.4s" }}>
            ...
            {/* CTAs */}
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fade-up" style={{ animationDelay: "0.5s" }}>
            ...
            {/* Scroll indicator */}
            <div className="pt-12 sm:pt-16 md:pt-20 flex justify-center animate-fade-up" style={{ animationDelay: "0.7s" }}>
              <Button 
                variant="ghost" 
                size="icon" 
