    ...
    return (
      <a href={link} target={target} rel={rel} className="block h-full">
        ...
        >
          ...
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#00d437]/20 via-transparent to-[#0096d4]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
          
          {/* Left accent line - different from Why Rook Links */}
          <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-[#00d437] to-[#0096d4] rounded-l-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

          {/* Icon wrapper */}
          <div className="relative mb-6 inline-flex">
            <div className="absolute inset-0 bg-[#00d437]/20 rounded-full blur-xl group-hover:blur-2xl transition-all duration-300 opacity-0 group-hover:opacity-100" />
            <div className="relative bg-gray-800/50 p-4 rounded-2xl border border-gray-700/50 group-hover:border-[#00d437]/40 transition-colors duration-300 backdrop-blur-sm">
              <div className="text-[#00d437] transform group-hover:scale-110 transition-transform duration-300">
                {icon}
              </div>
            </div>
          </div>
          ...
          {/* Content */}
          <h3 className="text-xl font-semibold mb-3 text-white group-hover:text-[#00d437] transition-colors duration-300">
            {title}
          </h3>
          ...
          {/* Learn more link */}
          <div className="flex items-center text-[#00d437] text-sm font-medium opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
