...
export const Press = () => {
  return (
    <section className="bg-[#f5f5f5] w-full overflow-x-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 md:pt-20 pb-0">
        ...
        <div className="max-w-3xl mx-auto">
          <Card className="border-none shadow-md bg-white">
            <div className="h-2 bg-[#34A853] w-full"></div>
            <CardContent className="p-8">
              ...
              <blockquote className="border-l-4 border-[#34A853] pl-6 italic text-[#121212] mb-8">
