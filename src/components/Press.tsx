    ...
    <section className="py-12 sm:py-16 md:py-20 bg-[#f5f5f5] w-full overflow-x-hidden mb-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-16 max-w-xl mx-auto text-center">
          ...
          <div className="h-1 w-16 bg-[#0D6E42] mx-auto"></div>
        </div>
        
        <div className="max-w-3xl mx-auto">
          <Card className="border-none shadow-md bg-white">
            <div className="h-2 bg-[#0D6E42] w-full"></div>
            <CardContent className="p-8">
              ...
              <blockquote className="border-l-4 border-[#0D6E42] pl-6 italic text-[#121212] mb-8">
              ...
              >
                <Button variant="link" className="p-0 text-[#0D6E42] hover:text-[#0D6E42]/80">
