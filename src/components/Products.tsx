    ...
    <section className="py-12 sm:py-16 md:py-20 bg-white w-full overflow-x-hidden mb-20" id="product">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10">
          ...
          {/* Rook Links Card */}
          <Card className="border border-[#34A853] shadow-md hover:shadow-lg transition-shadow duration-300 bg-white rounded-md flex flex-col h-full">
            <CardHeader className="pb-0">
            ...
            <CardContent className="pt-4 flex flex-col flex-grow">
              <div className="space-y-6 flex-grow">
                ...
                <ul className="space-y-2 sm:space-y-3">
                  <li className="flex items-start gap-2">
                    <div className="h-4 sm:h-5 w-[2px] bg-[#34A853] mt-1 flex-shrink-0"></div>
              ...
              <a href="/links" className="block mt-4 sm:mt-5 md:mt-6">
                <Button className="w-full bg-white hover:bg-gray-50 text-[#34A853] border-[#34A853] border group">
                  <span>Learn More</span>
                  <ArrowRight className="w-4 h-4 ml-1 transition-transform group-hover:translate-x-1" />
                </Button>
              </a>
