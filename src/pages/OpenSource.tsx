            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-textSecondary max-w-lg">
                  Explore our open-source projects, collaborate with passionate
                  developers, and shape a better internet, together.
                </p>
              </div>
          ...
          <Card className="bg-gray-50 border-none">
            <CardContent className="p-8">
              <blockquote className="text-xl text-textPrimary italic text-center">
                "Open code builds open trust. Every project we release reflects
                our obsession for clarity, performance, and impact."
              </blockquote>
