  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge variant="outline" className="text-[#0096d4] border-[#0096d4]">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-textPrimary mb-4">What is Rook Open Source?</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            {[
              { icon: <Brain className="h-8 w-8 text-[#0096d4]" />, title: "Transparency-first development" },
              { icon: <Package className="h-8 w-8 text-[#00d437]" />, title: "Modular, well-documented codebases" },
              { icon: <Users className="h-8 w-8 text-[#dc2e3e]" />, title: "Community before corporate" },
              { icon: <Shield className="h-8 w-8 text-[#ffd800]" />, title: "Security & best practices built in" }
            ].map((item, index) => (
          ...
          <Card className="bg-gray-50 border-none">
            <CardContent className="p-8">
              <blockquote className="text-xl text-textPrimary italic text-center">
                "Open code builds open trust. Every project we release reflects our obsession for clarity, performance, and impact."
              </blockquote>
              <p className="text-center text-textSecondary mt-4 font-medium">— Rook Dev Team</p>
            </CardContent>
          </Card>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-textSecondary max-w-4xl mx-auto">
              Paym.me by Rook is a developer-first open-source payment widget framework. Designed to embed payments into any site, SaaS, portfolio or product page — customizable, lightweight, and enterprise-ready.
            </p>
          </div>
            ...
            <CardContent className="space-y-4">
              {timeline.map((item, index) => (
                <div key={index} className="flex items-center space-x-4">
                  {item.icon}
                  <span className="font-medium text-textPrimary">{item.text}</span>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-textPrimary mb-4">Why Developers Love Us</h2>
            <p className="text-xl text-textSecondary">Community culture that puts developers first</p>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-8">
            <h3 className="text-xl font-bold text-textPrimary mb-6 text-center">Developer Testimonials</h3>
...
{/* Project Roadmap */}
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-textPrimary mb-4">Project Roadmap</h2>
            <p className="text-xl text-textSecondary">Transparent development timeline</p>
          </div>
