...
const HloLegal = () => {
  ...
  return (
    ...
    <div className="w-full min-h-screen bg-white pt-16 overflow-x-hidden">
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="flex justify-center animate-fade-up" style={{ animationDelay: "0.4s" }}>
              <Button 
                size="lg" 
                asChild
                className="bg-[#34A853] text-white hover:bg-[#34A853]/90 transition-all hover:translate-y-[-2px] group text-lg px-8 py-4"
              >
            ...
            <div className="absolute bottom-20 left-10 w-24 h-24 opacity-5 -z-10">
              <div className="w-full h-full rounded-full bg-[#34A853] animate-pulse" style={{ animationDelay: "1s" }}></div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  <div className="rounded-full bg-[#34A853]/10 p-2 mr-4 flex-shrink-0">
                    <Rocket className="h-5 w-5 text-[#34A853]" />
                  </div>
                  <div>
            ...
            <div className="relative">
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-premium border border-gray-100">
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-[#34A853]/10 rounded-lg p-4">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white w-full">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/60 backdrop-blur-sm p-8 rounded-2xl shadow-soft hover:shadow-premium transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
              <div className="rounded-full bg-[#34A853]/10 p-4 w-16 h-16 flex items-center justify-center mb-6">
                <Shield className="h-8 w-8 text-[#34A853]" />
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              ...
              <div className="relative z-10 space-y-12">
                ...
                <div className="flex items-center">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#34A853] text-white flex items-center justify-center text-xl font-bold">2</div>
                  <div className="ml-8 bg-white/60 backdrop-blur-sm rounded-xl p-6 shadow-soft flex-grow">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white w-full">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-soft border border-gray-100">
              <div className="text-4xl md:text-5xl font-bold mb-2 text-[#34A853]">${counters.funding}M+</div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gray-50/50 w-full">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white/60 backdrop-blur-sm p-8 rounded-2xl shadow-soft border border-gray-100">
              <div className="flex items-start">
                <div className="text-5xl text-[#34A853] mr-4">"</div>
                <div>
                  <p className="text-lg italic mb-6">
                  ...
                  <div className="flex items-center">
                    <div className="w-12 h-12 rounded-full bg-[#34A853]/10 flex items-center justify-center mr-4">
      ...
      {/* Call to Action */}
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-[#0096d4]/5 to-[#34A853]/5 w-full">
        <div className="container mx-auto px-4 max-w-7xl">
