  ...
  const dontsItems = [
    {
      ...
      description:
        "Don't use Rook's brand assets in the name of your business, product, service, app, or domain name.",
    ...
    },
    {
      ...
      title: "Logo Usage",
      description:
        "Don't use Rook's logos, icons, or designs, in any manner without express permission.",
    ...
    },
    {
      ...
      description:
        "Don't imply an affiliation, endorsement, sponsorship, or approval with or by Rook.",
    ...
    },
    {
      ...
      title: "Alterations",
      description:
        "Don't alter, animate, distort, or misappropriate Rook's brand assets.",
    ...
    },
    {
      ...
      title: "Prominence",
      description:
        "Don't use Rook's brand assets more prominently than your own brand.",
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Protecting our brand while enabling partners to communicate
                their relationship with Rook.
              </p>
            </div>
          </div>
        </section>
                ...
                >
                  <CardHeader className="pb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm font-medium text-[#00d437]">
                        {trademark.status}
                      </span>
                    </div>
                  </CardHeader>
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                To help you understand what you can and can't do with Rook's
                brand assets, we have created this comprehensive guide. In
                general, wordmarks can be used to truthfully convey information
                about your product or service, as long as customers will not be
                confused into believing Rook is affiliated with or endorses your
                offering.
              </p>
            </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {dosItems.map((item, index) => (
                  <Card
                    key={index}
                    className="border-l-4 border-[#00d437] shadow-sm bg-green-50/30"
                  >
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {dontsItems.map((item, index) => (
                  <Card
                    key={index}
                    className="border-l-4 border-[#dc2e3e] shadow-sm bg-red-50/30"
                  >
                    <CardContent className="p-6">
                      <div className="flex items-start space-x-3 mb-3">
                        {item.icon}
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Without a license arrangement with Rook, everything about
                      your app must be unique to you and free of Rook's brand
                      assets. You may only truthfully state compatibility within
                      your app description text.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-0 shadow-sm bg-white">
              ...
              <CardContent className="prose prose-lg max-w-none">
                <div className="space-y-6 text-gray-600 text-center">
                  <p>
                    <strong>Rook®</strong> and <strong>Donum Club®</strong> are
                    registered trademarks owned by Rook. All rights reserved.
                  </p>
                  ...
                  <p>
                    For licensing inquiries or questions regarding the use of
                    our trademarks, contact our legal department at{" "}
                    <strong>legal@rookhq.com</strong>.
                  </p>

                  <div className="mt-8 p-6 bg-gray-50 rounded-lg">
                    <p className="text-sm italic">
                      Include a trademark footnote: "Rook, Donum Club are
                      trademarks of Rook. All other trademarks are the property
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 max-w-6xl text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Contact our legal team for trademark inquiries and licensing
              questions.
            </p>
