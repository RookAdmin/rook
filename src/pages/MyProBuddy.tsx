  ...
  return (
    ...
    <div className="w-full min-h-screen bg-white pt-16 overflow-x-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 max-w-4xl mx-auto mb-8 sm:mb-10 md:mb-12 animate-fade-up px-4 sm:px-0" style={{ animationDelay: "0.2s" }}>
              The venture-acceleration partnership that empowers founders with <span className="text-[#34A853] font-semibold">smart tools</span>, <span className="text-[#0096d4] font-semibold">strategic mentorship</span>, and <span className="text-[#dc2e3e] font-semibold">investor connections</span>.
            </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-soft hover:shadow-premium transition-all duration-300 transform hover:-translate-y-1">
              <CardContent className="p-8 text-center">
                <div className="w-16 h-16 bg-[#34A853]/10 rounded-full flex items-center justify-center mx-auto mb-6">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            <div className="h-1 w-12 sm:w-16 md:w-20 bg-[#34A853] mx-auto mb-4 sm:mb-6"></div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-white/90 backdrop-blur-sm border border-[#34A853]/20 shadow-premium hover:shadow-card transition-all duration-300 transform hover:-translate-y-2">
              <CardContent className="p-10">
                <div className="w-20 h-20 bg-[#34A853]/10 rounded-2xl flex items-center justify-center mb-8">
                  <Rocket className="h-10 w-10 text-[#34A853]" />
                </div>
