...
const Support = () => {
  ...
  const knowledgeBaseTools = [
    {
      ...
      iconLogo: "/rook-saas-assets/rook-links.png", // Icon-only logo
    ...
    },
    {
      ...
      iconLogo: "/rook-saas-assets/rook-scoop.png", // Icon-only logo
    ...
    },
    {
      ...
      iconLogo: "/rook-saas-assets/paym-logo.png", // Icon-only logo
  ...
  const allArticles = [
    ...
    },
    {
      ...
      toolSlug: "rook-scoop",
      category: "Planning",
      tags: ["security", "compliance", "gdpr", "soc2", "enterprise"]
    },
    {
